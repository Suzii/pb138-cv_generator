    ...
    <body data-ng-controller="FormController" id="top">
        ...
        <div class="jumbotron">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h2 data-ng-bind="data['personal-details']['given-names']">Name</h2>
                        <h3 data-ng-bind="data['personal-details'].surname">Surname</h3>
                    </div>
        ...
        <div class="container">
            ...
            <form action="${pageContext.request.contextPath}/edit/save" class="form-horizontal" method="POST" name="userForm"  id="cvForm" data-ng-submit="$event.preventDefault();
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group"  data-ng-class="{'has-error': userForm.dateOfBirth.$invalid && (!userForm.dateOfBirth.$pristine || showError)}">
                            ...
                            <div class="col-sm-9" data-ng-controller="DateController">
                                <div data-ng-form="dateOfBirth" class="form-inline">
                                    <div class="form-group">
                                        <select class="form-control" id="dateOfBirth" data-ng-model="data['personal-details']['date-of-birth'].day" data-ng-options="d for d in days" required>
                        ...
                        <!-- **************************** phones ************************** -->
                        <div data-ng-repeat="phone in data['personal-details'].phones" data-ng-form="phoneForm" class="form-group"  data-ng-class="{
                                'has-error'
                        ...
                        <div data-ng-repeat="email in data['personal-details'].emails" data-ng-form="emailForm" class="form-group"  data-ng-class="{
                                'has-error'
                        ...
                        <div data-ng-repeat="social in data['personal-details'].social" data-ng-form="socialForm" class="form-group"  data-ng-class="{
                                'has-error'
                ...
                <div class="row">
                    ...
                    <div data-ng-repeat="edu in data.education" data-ng-form="eduForm" class="box form-group"  data-ng-class="{
                            'has-error'
                ...
                <div class="row">
                    ...
                    <div data-ng-repeat="emp in data.employment" data-ng-form="empForm" class="box form-group" data-ng-class="{
                            'has-error'
                ...
                <div class="row">
                    ...
                    <div data-ng-repeat="skill in data['language-skills']" data-ng-form="langForm" class="box form-group" data-ng-class="{
                            'has-error'
                                    : langForm.$invalid && (!langForm.$pristine || showError)}">
                        <!-- data-ng-form name="langForm" class="form-group"-->
                        <div class="row">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                ...
                                <select name="lang-level-{{$index}}" id="lang-level-{{$index}}" data-ng-model="skill.level"  class="form-control" required >
                ...
                <div class="row">
                    ...
                    <div data-ng-repeat="skill in data['computer-skills']" data-ng-form="compForm" class="box form-group" data-ng-class="{
                            'has-error'
                ...
                <div class="row">
                    ...
                    <div data-ng-repeat="skill in data['driving-licence']" data-ng-form="driveForm" class="box form-group" data-ng-class="{
                            'has-error'
                ...
                <div class="row">
                    ...
                    <div data-ng-repeat="cert in data.certificates" data-ng-form="certForm" class="box form-group" data-ng-class="{
                            'has-error'
